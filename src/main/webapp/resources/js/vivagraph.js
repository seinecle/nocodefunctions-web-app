        ...
        return s
                ...
                function createLayout(graph, physicsSettings) {
                    ...
                    var api = {
                        ...
                        step: function () {
                            if (bodiesCount === 0)
                                return true; // TODO: This will never fire 'stable'
...
// Allow other developers have their own createGraph
                ...
                function factory(createGraph) {
                    ...
                    function cliqueCircle(cliqueCount, cliqueSize) {
                        ...
                        if (cliqueCount < 1)
                            throw new Error('Invalid number of cliqueCount in cliqueCircle');
                        if (cliqueSize < 1)
                            throw new Error('Invalid number of cliqueSize in cliqueCircle');
...
// need this for old browsers. Should this be a separate module?
                ...
                function augment(element) {
                    ...
                    function dataSource(model) {
                        if (!compiledTempalte)
                            compiledTempalte = compileTemplate(svgElement);
                ...
                function extractAllBindings(domNode, allBindings) {
                    ...
                    if (!domNode.attributes)
                        return; // this might be a text. Need to figure out what to do in that case
                ...
                function bindDomAttribute(domAttribute, element, allBindings) {
                    ...
                    if (!value)
                        return; // unary attribute?

                    var modelNameMatch = value.match(BINDING_EXPR);
                    if (!modelNameMatch)
                        return; // does not look like a binding
