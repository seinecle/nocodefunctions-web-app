...
/**
 * Represents a source of data for the topics workflow. This is a sealed
...
public sealed interface TopicsDataSource {
     ...
     */
    record WebSite(String rootUrl, int maxUrls, List<String> exclusionTerms) implements TopicsDataSource {}
}
