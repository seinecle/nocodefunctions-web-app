...
@SessionScoped
@MultipartConfig
public class KeynodeInsightBean implements Serializable {
        ...
        Runnable progressBarIncrement = () -> {
            while (gexfAsByteArrayResult == null) {
                ...
                try {
                    ...
                    Logger.getLogger(KeynodeInsightBean.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        };
