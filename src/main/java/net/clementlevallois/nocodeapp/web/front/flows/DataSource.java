...
public sealed interface DataSource {
     ...
     */
    record FileUpload(List<UploadedFile> files) implements DataSource {}
     ...
     */
    record WebPage(String url) implements DataSource {}
     ...
     */
    record WebSite(String rootUrl, int maxUrls, List<String> exclusionTerms) implements DataSource {}
}